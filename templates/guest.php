<section class="welcome">
    <h2 class="welcome__heading">«TM Tool»</h2>

    <div class="welcome__text">
        <p>«TM Tool» — это веб приложение для удобного ведения списка дел. Сервис помогает пользователям не забывать о предстоящих важных событиях и задачах.</p>
